...
if !hasmapto('<Plug>PainlessdigraphToggle')
  map <silent> <Leader>od  <Plug>(PainlessdigraphToggle)
endif
...
function! s:EnableDigraph()
  ...
  augroup END
  if has('nvim')
      lua vim.notify("Enabled Painless Digraphs")
  else
      echo "Enabled Painless Digraphs"
  endif
endfunction
...
function! s:DisableDigraph()
  ...
  augroup END
  if has('nvim')
      lua vim.notify("Disabled Painless Digraphs")
  else
      echo "Disabled Painless Digraphs"
  endif
endfunction
